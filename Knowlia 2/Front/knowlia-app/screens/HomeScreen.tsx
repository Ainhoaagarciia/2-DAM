...
export default function HomeScreen() {
  ...
  if (!videoDestacado && !loading) return <View style={{marginTop:50}}><Text style={{textAlign:'center'}}>No hay videos destacados</Text></View>;

  const videosFiltrados = videos.filter(v => v.id !== videoDestacado.id);
          ...
          <View style={{ paddingHorizontal: 15, paddingVertical: 12 }}>
            <View style={{ flexDirection: "row", alignItems: "flex-start", marginBottom: 5 }}>
              <View style={{ flex: 1, justifyContent: "center" }}>
                ...
                <Text style={{ color: "#2B74E4", fontWeight: "bold", fontSize: 15, marginTop: 4, marginBottom: 0, textAlign: "left" }}>
                  {Array.isArray(videoDestacado.videoCategorias) && videoDestacado.videoCategorias.length > 0
                    ? (videoDestacado.videoCategorias[0]?.categoria?.nombre || "Sin categoría")
                    : "Sin categoría"}
                </Text>
              </View>
            </View>
            <View style={styles.midRow}>
              ...
              <Text style={styles.precioPill}>
                {videoDestacado.precio && videoDestacado.precio !== "0" ? `${videoDestacado.precio} €` : "Gratis"}
              </Text>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  avatarCircle: { width: 56, height: 56, borderRadius: 28, borderWidth: 3, borderColor: "#69a4f8", justifyContent: "center", alignItems: "center", backgroundColor: "#ddefff", shadowColor: "#bbd8f6", shadowOpacity: 0.22, shadowRadius: 6, elevation: 3 },
  avatarCabecera: { width: 48, height: 48, borderRadius: 24, backgroundColor: "#eee"  },
  badgeTrending: { position: "absolute", top: 13, left: 15, backgroundColor: "#2B74E4", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 4, zIndex: 10, borderColor: "#06359bff", borderWidth: 1.5 },
  trendingText: { color: "#fff", fontWeight: "bold", fontSize: 13, letterSpacing: .5 },
  cardMid: { marginHorizontal: 22, borderRadius: 19, marginBottom: 10, marginTop: 2, alignItems: 'center', overflow: "hidden", position: "relative" },
  portadaBig: { width: SCREEN_WIDTH - 44, height: 200, borderRadius: 19, backgroundColor: "#f2f2f2", borderColor: "#06359bff", borderWidth: 1.3 },
  tituloMid: { fontWeight: "900", fontSize: 20, color: "#232323", maxWidth: "68%" },
  midRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", width: "100%", marginTop: 4 },
  estrellasMid: { color: "#232323", fontWeight: "bold", fontSize: 16 },
  countValoraciones: { color: "#8a929b", fontWeight: "bold", fontSize: 15, marginLeft: 4 },
  precioPill: { backgroundColor: "#2B74E4", color: "#fff", fontWeight: "bold", fontSize: 16, borderRadius: 22, paddingVertical: 3, paddingHorizontal: 18, minWidth: 76, textAlign: "center", marginLeft: 12 },
  cursoPopularCardRow: { flexDirection: "row", alignItems: "center", backgroundColor: "#fff", borderRadius: 14, marginHorizontal: 18, marginBottom: 11, padding: 12, elevation: 2, shadowColor: '#134cc7ff', shadowOpacity: 0.005, shadowRadius: 2, shadowOffset: { width: 0, height: 3 } },
  cursoPopularThumb: { width: 48, height: 48, borderRadius: 11, backgroundColor: "#f0f4fa", justifyContent: "center", alignItems: "center", overflow: "hidden" },
  cursoPopularTitulo: { fontWeight: "bold", fontSize: 16, marginBottom: 1, color: "#222" },
  cursoPopularCategoria: { color: "#2B74E4", fontWeight: "bold", fontSize: 14, marginLeft: 8, opacity: 0.93 },
  cursoPopularPrecio: { backgroundColor: "#2B74E4", color: "#fff", fontWeight: "bold", fontSize: 14, borderRadius: 11, paddingHorizontal: 10, paddingVertical: 4, marginBottom: 1, textAlign: "right" },
  estrellasMini: { color: "#232323", fontWeight: "bold", fontSize: 12, marginLeft: 2, marginRight: 2 }
});